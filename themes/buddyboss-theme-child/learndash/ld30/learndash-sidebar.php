    ...
    <div class="lms-topic-sidebar-data">
                ...
                <ol class="bb-lessons-list">
                    ...
                    foreach ($lession_list as $lesson) {
                        ...
                        if ($bb_lesson_has_access || (!$bb_lesson_has_access && apply_filters('bb_theme_ld_show_locked_lessons', true))) {
                            ?>
                            <li
                                class="lms-lesson-item <?php echo $lesson->ID === $post->ID ? esc_attr('current') : esc_attr('lms-lesson-turnover'); ?> <?php echo esc_attr($lesson_sample . ' ' . $locked_class); ?> <?php echo (!empty($lesson_topics) || !empty($lesson_quizzes)) ? '' : esc_attr('bb-lesson-item-no-topics'); ?>">
                                ...
                                <a href="<?php echo esc_url(get_permalink($lesson->ID)); ?>"
                                    title="<?php echo esc_attr($lesson->post_title); ?>" class="bb-lesson-head flex">
                                    <?php
                                    ...
                                    ?>
                                    <div
                                        class="flex-1 push-left <?php echo $completed ? esc_attr('bb-completed-item') : esc_attr('bb-not-completed-item'); ?>">
                                    ...
                                    <div
                                        class="flex align-items-center <?php echo '100' === (int) $lesson_progress['percentage'] ? esc_attr('bb-check-completed') : esc_attr('bb-check-not-completed'); ?>">
                                        <div class="bb-lms-progress-wrap" data-balloon-pos="left"
                                            data-balloon="<?php echo esc_attr($lesson_progress_data_balloon); ?>">
                                            <?php
                                            if (learndash_is_lesson_complete(null, $lesson->ID, $course_id) && 100 === (int) $lesson_progress['percentage']) {
                                                ?>
                                                <div class="i-progress i-progress-completed"><i class="bb-icon-l bb-icon-check"></i>
                                                </div>
                                                <?php
                                            } else {
                                                ?>
                                                <div class="bb-progress <?php echo $completed ? esc_attr('bb-completed') : esc_attr('bb-not-completed'); ?>"
                                                    data-percentage="<?php echo esc_attr($lesson_progress['percentage']); ?>">
                                        ...
                                        <ol class="bb-type-list">
                                            ...
                                            foreach ($lesson_topics as $lesson_topic) {
                                                ...
                                                if ($bb_topic_has_access || (!$bb_topic_has_access && apply_filters('bb_theme_ld_show_locked_topics', true))) {
                                                    ?>
                                                    <li
                                                        class="lms-topic-item <?php echo $lesson_topic->ID === $post->ID ? esc_attr('current') : ''; ?> <?php echo (!empty($learndash_available_date)) ? 'lms-topic-is-locked' : 'lms-topic-not-locked'; ?>">
                                                        <a class="flex bb-title bb-lms-title-wrap"
                                                            href="<?php echo esc_url(get_permalink($lesson_topic->ID)); ?>"
                                                            title="<?php echo esc_attr($lesson_topic->post_title); ?>">
                                                            <?php
                                                            ...
                                                            if (!empty($lesson_video_enabled)) {
                                                                ...
                                                                <span class="bb-lms-ico bb-lms-ico-topic"><i
                                                                        class="bb-icon-bl bb-icon-play"></i></span>
                                                                <?php
                                                            } else {
                                                                ?>
                                                                <span class="bb-lms-ico bb-lms-ico-topic"><i
                                                                        class="bb-icon-l bb-icon-text"></i></span>
                                                                <?php
                                                            }
                                                            ?>
                                                            <span
                                                                class="flex-1 bb-lms-title <?php echo $completed ? esc_attr('bb-completed-item') : esc_attr('bb-not-completed-item'); ?>"><?php echo $lesson_topic->post_title; ?></span>
                                                            <?php
                                                            if (!empty($attributes)):
                                                                foreach ($attributes as $attribute):
                                                                    if ($attribute['icon'] == 'ld-icon-calendar'):
                                                                        ?>
                                                                        <span class="lms-topic-status-icon" data-balloon-pos="left"
                                                                            data-balloon="<?php echo esc_attr($attribute['label']); ?>"><i
                                                                                class="bb-icon-f bb-icon-lock"></i></span>
                                                                        <?php
                                                                    endif;
                                                                endforeach;
                                                            endif;
                                                            ...
                                                            if ((!empty($course_progress[$course_id]['topics'][$lesson->ID][$lesson_topic->ID]) && 1 === $course_progress[$course_id]['topics'][$lesson->ID][$lesson_topic->ID])):
                                                                ?>
                                                                <div class="bb-completed bb-lms-status" data-balloon-pos="left"
                                                                    data-balloon="<?php esc_attr_e('Completed', 'buddyboss-theme'); ?>">
                                                                    <div class="i-progress i-progress-completed"><i
                                                                            class="bb-icon-l bb-icon-check"></i></div>
                                                                </div>
                                                                <?php
                                                            else:
                                                                ?>
                                                                <div class="bb-not-completed bb-lms-status" data-balloon-pos="left"
                                                                    data-balloon="<?php esc_attr_e('Not Completed', 'buddyboss-theme'); ?>">
                                                                    <div class="i-progress i-progress-not-completed"><i
                                                                            class="bb-icon-l bb-icon-circle"></i></div>
                                                                </div>
                                                                <?php
                                                            endif;
                                                            ?>
                                                            ...
                                                            <ol class="lms-quiz-list">
                                                                ...
                                                                foreach ($topic_quizzes as $topic_quiz) {
                                                                    ...
                                                                    if ($bb_quiz_has_access || (!$bb_quiz_has_access && apply_filters('bb_theme_ld_show_locked_quizzes', true))) {
                                                                        ?>
                                                                        <li
                                                                            class="lms-quiz-item <?php echo esc_attr($topic_quiz['post']->ID == $post->ID ? esc_attr('current') : ''); ?> <?php echo isset($scheduled_class) ? esc_attr($scheduled_class) : ''; ?>">
                                                                            <a class="flex bb-title bb-lms-title-wrap"
                                                                                href="<?php echo esc_url(get_permalink($topic_quiz['post']->ID)); ?>"
                                                                                title="<?php echo esc_attr($topic_quiz['post']->post_title); ?>">
                                                                                <span class="bb-lms-ico bb-lms-ico-quiz"><i
                                                                                        class="bb-icon-rl bb-icon-question"></i></span>
                                                                                <span
                                                                                    class="flex-1 bb-lms-title <?php echo learndash_is_quiz_complete($user_id, $topic_quiz['post']->ID, $course_id) ? esc_attr('bb-completed-item') : esc_attr('bb-not-completed-item'); ?>">
                                                                                ...
                                                                                if (isset($scheduled_class) && $scheduled_class == 'lms-is-scheduled'):
                                                                                    ?>
                                                                                    <span class="lms-quiz-status-icon" data-balloon-pos="left"
                                                                                        data-balloon="<?php echo esc_attr($attribute['label']); ?>"><i
                                                                                            class="bb-icon-f bb-icon-lock"></i></span>
                                                                                    <?php
                                                                                endif;
                                        ...
                                        <ul class="lms-quiz-list">
                                            ...
                                            foreach ($lesson_quizzes as $lesson_quiz) {
                                                ...
                                                if ($bb_quiz_has_access || (!$bb_quiz_has_access && apply_filters('bb_theme_ld_show_locked_quizzes', true))) {
                                                    ?>
                                                    <li
                                                        class="lms-quiz-item <?php echo esc_attr($lesson_quiz['post']->ID == $post->ID ? esc_attr('current') : ''); ?> <?php echo isset($scheduled_class) ? esc_attr($scheduled_class) : ''; ?>">
                                                        <a class="flex bb-title bb-lms-title-wrap"
                                                            href="<?php echo esc_url(get_permalink($lesson_quiz['post']->ID)); ?>"
                                                            title="<?php echo esc_attr($lesson_quiz['post']->post_title); ?>">
                                                            <span class="bb-lms-ico bb-lms-ico-quiz"><i
                                                                    class="bb-icon-rl bb-icon-question"></i></span>
                                                            <span
                                                                class="flex-1 bb-lms-title <?php echo learndash_is_quiz_complete($user_id, $lesson_quiz['post']->ID, $course_id) ? esc_attr('bb-completed-item') : esc_attr('bb-not-completed-item'); ?>"><?php echo $lesson_quiz['post']->post_title; ?></span>
                                                            <?php
                                                            if (isset($scheduled_class) && $scheduled_class == 'lms-is-scheduled'):
                                                                ?>
                                                                <span class="lms-quiz-status-icon" data-balloon-pos="left"
            ...
            <div class="lms-course-quizzes-list">
                ...
                <ul class="lms-quiz-list bb-type-list">
                    ...
                    foreach ($course_quizzes as $course_quiz) {
                        ...
                        ?>
                        <li
                            class="lms-quiz-item <?php echo $course_quiz['post']->ID == $post->ID ? esc_attr('current') : ''; ?> <?php echo esc_attr($locked_class); ?> <?php echo isset($scheduled_class) ? esc_attr($scheduled_class) : ''; ?>">
                            <a class="flex bb-title bb-lms-title-wrap"
                                href="<?php echo esc_url(get_permalink($course_quiz['post']->ID)); ?>"
                                title="<?php echo esc_attr($course_quiz['post']->post_title); ?>">
                                <span class="bb-lms-ico bb-lms-ico-quiz"><i class="bb-icon-rl bb-icon-question"></i></span>
                                <span
                                    class="flex-1 push-left bb-lms-title <?php echo learndash_is_quiz_complete($user_id, $course_quiz['post']->ID, $course_id) ? esc_attr('bb-completed-item') : esc_attr('bb-not-completed-item'); ?>">
        ...
        if (buddyboss_theme_get_option('learndash_course_participants', null, true) && !empty($members)):
            ...
            <div class="lms-course-members-list">
                ...
                <input type="hidden" name="buddyboss_theme_learndash_course_participants_course_id"
                    id="buddyboss_theme_learndash_course_participants_course_id"
                ...
                <div class="bb-course-member-wrap">
                        ...
                        foreach ($members as $course_member):
                            ...
                            <li>
                                ...
                                <?php if (class_exists('BuddyPress')) { ?>
                                    ...
                                    <?php } ?>
                                    <img class="round"
                                        src="<?php echo esc_url(get_avatar_url((int) $course_member, array('size' => 96))); ?>"
                                        alt="" />
                                    <?php
                    ...
                    if ($members_count > 5) {
                        ?>
                        <a href="javascript:void(0);" class="list-members-extra lme-more"><span class="members-count-g"></span>
                            <?php esc_html_e('Show more', 'buddyboss-theme'); ?><i
                                class="bb-icon-l bb-icon-angle-down"></i></a>
                        <?php
                    }
                    ?>
                </div>
