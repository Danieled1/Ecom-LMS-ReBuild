	...
	<div class="ld-progress <?php echo ( 'course' === $context ) ? esc_attr( 'ld-progress-inline' ) : ''; ?>">
		...
		<?php endif; ?>
			...
			<div class="ld-progress-bar">
				<div class="bar-styles ld-progress-bar-percentage ld-secondary-background" style="<?php echo esc_attr( 'width:' . $progress['percentage'] . '%' ); ?>"></div>
			</div>
			<div class="ld-progress-stats">
				<div class="ld-progress-percentage ld-secondary-color course-completion-rate">
                    <div class="card-course-precent">
					<?php
					echo sprintf(
				...
				<div class="card-course-last-activity ld-progress-steps">
					<?php
